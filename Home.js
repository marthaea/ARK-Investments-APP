  ...
  return (
    <div className="home">
      ...
      <section className="about-company">
        <h2>About ARK Investments</h2>
        <p>
          ARK Investments is a leading real estate company dedicated to helping clients buy, sell, and rent properties
          with ease. With years of experience, we are committed to delivering excellent services that meet the unique
